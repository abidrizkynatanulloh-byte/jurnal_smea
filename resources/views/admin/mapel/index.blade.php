...
<div id="modalEditMapel" class="fixed inset-0 z-50 bg-slate-900/40 backdrop-blur-xs flex items-center justify-center hidden p-4">
    <div class="bg-white rounded-xl border border-slate-200 shadow-xl max-w-sm w-full p-4.5 space-y-3">
        ...
        <form id="formEditMapel" method="POST" class="space-y-2.5">
            @csrf
            @method('PUT')

            <div>
                <label for="edit_kode_mapel" class="block text-[11px] font-semibold text-slate-700 mb-0.5">Kode Mapel *</label>
            ...
            <div>
                <label for="edit_nama_mapel" class="block text-[11px] font-semibold text-slate-700 mb-0.5">Nama Mata Pelajaran *</label>
            ...
            <div class="flex items-center justify-end space-x-2 pt-2 border-t border-slate-100">
                <button type="button" onclick="closeEditMapelModal()" class="h-8 px-3 border border-slate-200 rounded-lg text-xs font-medium text-slate-600 hover:bg-slate-50 cursor-pointer">
                    Batal
                </button>
